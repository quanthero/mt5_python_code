...
def fetch_market_data():
    rates = mt5.copy_rates_from_pos(symbol, mt5.TIMEFRAME_M5, 0, 100)  # Get recent 1000 1-minute data
...
def execute_strategy():
    ...
    if data['signal'].iloc[-1] == 1 and not has_position and not executed_trade:
        ...
        request = {
            ...
            "type_filling": mt5.ORDER_FILLING_IOC,  # Change to Fill or Kill
        }
...
while True:
    # Get current time
    time_candle = mt5.copy_rates_from_pos(symbol, mt5.TIMEFRAME_M5, 0, 1)
